...
<section class="modal-wrapper">
	<main
		...
		} bg-gray-200 mb-20 p-8 m-auto rounded-sm border-2 border-gray-300 mt-20 overflow-hidden`}
	>
		<div class="w-full max-w-md space-y-4">
			<h2 class="font-sans text-left text-2xl font-light tracking-tight text-gray-500">
