...
<Modal {onClose}>
	...
	>
      ...
      class="font-bold font-sans group relative flex w-full justify-center rounded-sm border border-gray-500 py-2 px-4 text-lg font-medium text-gray-800 bg-[#F49690] hover:bg-[#F2857D] focus:outline-none focus:ring-2 focus:gray-300 focus:ring-offset-2 drop-shadow-sm ease-in-out duration-300 mt-6"
		>
			{#if inProgress}
				<LoadingSpinner />
			{:else}
