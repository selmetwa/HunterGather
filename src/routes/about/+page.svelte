<section class="py-12">
	<div class="w-full md:w-full lg:w-10/12 mt-6 md:mt-12 grid md:grid-cols-2 gap-8 mx-auto">
		<div>
			<h1
				class="mt-12 font-sans text-left text-[40px] lg:text-[45px] font-bold tracking-tight text-gray-400 leading-[45px]"
			>
	...
	<div class="w-full md:w-8/12 mx-auto mt-12 grid md:grid-cols-3 gap-6 mt-16">
		<div class="h-full rounded p-4">
			<h3 class="font-sans text-center font-medium tracking-tight text-gray-800 text-[22px] mt-2">
				Visual Bookmarking
			</h3>
			...
			<!-- <img src="../../../asd.svg" class="p-6" alt="picture of block cards" /> -->
		</div>
		<div class="h-full rounded p-4">
			<h3 class="font-sans text-center font-medium tracking-tight text-gray-800 text-[22px] mt-2">
				Chrome Extension
			...
			<!-- <img src="../../../evttt.svg" class="p-6" alt="picture of chrome extension" /> -->
		</div>
		<div class="h-full rounded p-4">
			<h3 class="font-sans text-center font-medium tracking-tight text-gray-800 text-[22px] mt-2">
				Collections
			...
			<!-- <img src="../../../col.png" class="p-6" alt="picture of collection card" /> -->
		</div>
  <p class="text-gray-400 font-light text-xl">Made by <a href="https://selmetwa.github.io/portfolio/" target="_blank" class="text-blue-400 ">Sherif Elmetwally</a>, check out the <a class="text-blue-400" href="https://github.com/selmetwa/HunterGather" target="_blank">source code</a></p>
	</div>
</section>
